...
from GUI import LoginPage, MainOverviewPage, StudentCourseOverviewPage, StudentOverviewPage, NewStudentPage, \
    ManageCoursesPage
...
class LC_window(tk.Tk):
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        filemenu.add_command(label="Show All Students", command=lambda: self.show_frame(MainOverviewPage.MainOverviewPage))
        ...
        for F in (MainOverviewPage.MainOverviewPage, StudentOverviewPage.StudentOverviewPage, ManageCoursesPage.ManageCoursesPage, StudentCourseOverviewPage.StudentCourseOverviewPage, NewStudentPage.NewStudentPage):
        ...
        self.show_frame(MainOverviewPage.MainOverviewPage)
